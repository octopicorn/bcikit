...
// ****
// this object has one websocket "ws" which can communicate send/receive messages
// to & from multiple channels
// channels are kept in an object
...
// public function channel(raw_name)
...
// a single channel has a name and defines its own individual send() method
// it can also close() itself
// send() commands proxy directly up to the parent Multiplexer class, passing along channel name to disambiguate
