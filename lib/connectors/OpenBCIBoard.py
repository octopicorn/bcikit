...
class OpenBCIBoard(object):
  ...
  def __init__(self, port='/dev/tty.usbserial-DN0094CZ', baud=115200, filter_data=True, num_channels=8):
  ...
  def _read_serial_binary(self, max_bytes_to_skip=3000):
    ...
    for rep in xrange(max_bytes_to_skip):
      ...
      if self.read_state == 0:
        ...
        channel_data = []
        for c in xrange(self.channels_per_packet):
